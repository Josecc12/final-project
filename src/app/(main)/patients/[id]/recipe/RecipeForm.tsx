...
const schema = z.object({
    ...
    insumos: z.array(
        z.object({
            ...
            uso: z.string().min(1, 'Ingresa el uso del insumo')
        })
    ),
})
            ...
            <CardContent className="gap-3 flex flex-col">
                ...
                {fields.map((field, index) => (
                    <div key={field.id} className="flex flex-col gap-2">
                        ...
                        <label htmlFor={`insumos.${index}.Uso`} className="text-sm font-medium">
                            Uso
                        </label>
                        <Input

                            id={`insumos.${index}.uso`}
                            type="text"
                            {...register(`insumos.${index}.uso` as const, {
                ...
                <Button
                    ...
                    variant="outline"
                    size="sm"
                    onClick={() => append({ cantidad: 1, insumo: "", uso: "" })}
                    className="w-fit"
                >
